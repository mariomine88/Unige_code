...
Sphere spheres[numSpheres] = Sphere[](
    Sphere(vec3(0.0, 1.0, 0.0), 1.0, Material(vec3(0.8, 0.2, 0.2) , vec3(0.84f, 0.83f, 0.02f), 10.0 ,0.0)),
    Sphere(vec3(0.0, -1000.0, 0.0), 1000.0, Material(vec3(0.3725, 0.2902, 0.0745), vec3(0.0), 0.0 ,.5))
);
