...
Sphere spheres[numSpheres] = Sphere[](
    Sphere(vec3(0.0, 1.0, 0.0), 1.0, Material(vec3(1.0, 1.0, 1.0) , vec3(0.84f, 0.83f, 0.02f), 0.0 ,0.0 ,0.0 ,1.3 , vec3(1.0f, 1.0f, 0.0f))),
    Sphere(vec3(0.0, -1000.0, 0.0), 1000.0, Material(vec3(0.3725, 0.2902, 0.0745), vec3(0.0), 0.0 ,1.5, .8,0.0 , vec3(0.1, 0.1, 0.1)))
);
